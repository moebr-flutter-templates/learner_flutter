        ...
        children: <Widget>[
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[text(model.name, fontFamily: fontMedium, fontSize: textSizeLargeMedium, maxLine: 2, isLongText: true), text(model.subtitle, isLongText: true, maxLine: 2), text(model.type, textColor: learner_colorPrimary)],
            ),
          )
        ],
      ),
