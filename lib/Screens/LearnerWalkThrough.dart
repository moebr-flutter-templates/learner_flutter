...
import 'package:learner_flutter/Screens/LearnerDashboard.dart';
import 'package:learner_flutter/Screens/LearnerLogin.dart';
...
import 'package:learner_flutter/utils/LearnerWidget.dart';
        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            child: Align(
              ...
              child: DotsIndicator(dotsCount: 3, position: currentIndexPage.toDouble(), decorator: DotsDecorator(color: learner_greyColor, activeColor: learner_colorPrimary)),
            ),
          ),
          Positioned(
            width: MediaQuery.of(context).size.width,
